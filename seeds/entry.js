  ...
  return knex('entry').del()
    .then(function () {
      return Promise.all([
        ...
        mood_id: 55, created_at: '2017-05-20 06:18:41'}),
        ...
        mood_id: 35, created_at: '2017-05-21 06:18:41'}),
        ...
        mood_id: 24, created_at: '2017-05-22 06:18:41'}),
        knex('entry').insert({id: 76, title: "It's title time", text: "Bad day ):",
        mood_id: 22, created_at: '2017-05-23 06:18:41'}),
