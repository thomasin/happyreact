...
const Nav = props => {
  ...
  let middleLink = location.hash == '#/add-entry' ? <Link to="/" className="button">Entry List</Link> : <Link to="/add-entry" className="button button-primary" style={middleLinkStyle}>Add entry</Link>
